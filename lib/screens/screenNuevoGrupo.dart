...
//! la lista de contactos del cuerpo
      ...
      children: <Widget>[
        Padding(
          ...
          child: Container(
            ...
            child: ListView(
              children: <Widget>[
                _myBody2("assets/img/telegram.png", "Telegram",
              "últ. vez el 26 de mar. a las 13:58", "", ""),
          _myDivider(),
          _myBody2("assets/img/flutter.png", "Flutter - Dart Español",
              "últ. vez el 26 de mar. a las 13:58", "", ""),
          _myDivider(),
          ...
          _myDivider(),
          _myBody2(
              "assets/img/thor.jpg", "Thor", "últ. vez el 26 de mar. a las 13:58", "", ""),
          _myDivider(),
              ],
            ),
          ),
  ...
  Widget _myBody2(String rutaImagen, String nombreTitulo,
  ...
  Widget _nameAndTime(
      String nombreTitulo, String mensaje, String hora, String cantidadMensajes) {
    return Container(
          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                ...
                Text(mensaje, style: TextStyle(color: Colors.black54),),
              ],
            ),
            Column(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
